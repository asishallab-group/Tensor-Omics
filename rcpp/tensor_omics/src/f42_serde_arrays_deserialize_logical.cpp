...
extern "C" {
    void deserialize_logical_helper_c(bool*, const int*, const int*, const int*, const char*, const int*, int*);
}

// [[Rcpp::export(.deserialize_logical_helper_rcpp)]]
List deserialize_logical_helper_rcpp(IntegerVector arr_shape, CharacterVector filename) {
    ...
    tox::BoolBuffer arr_c((int) std::accumulate(arr_shape.begin(), arr_shape.end(), 1, std::multiplies<int>()));
    int ierr = 0;
