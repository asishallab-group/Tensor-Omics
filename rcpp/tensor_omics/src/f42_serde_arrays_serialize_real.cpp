...
extern "C" {
    void serialize_real_helper_c(const double*, const int*, const int*, const int*, const char*, const int*, int*);
}

// [[Rcpp::export(.serialize_real_helper_rcpp)]]
List serialize_real_helper_rcpp(NumericVector arr, CharacterVector filename) {
