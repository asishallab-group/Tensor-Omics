...
#'
#' Generated from the Fortran procedure \code{f42_serde_arrays_serialize_logical::serialize_logical_helper}.
#' @export
serialize_logical_helper <- function(arr, filename) {
    ...
    .result <- .serialize_logical_helper_rcpp(arr, filename)
