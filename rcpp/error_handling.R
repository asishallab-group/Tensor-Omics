check_err_code <- function(ierr) {
  ...
  msg <- switch(as.character(ierr),
    ...
    '401' = "Normalization failed: standard deviation is zero.",
    '402' = "Quantile normalization failed: invalid stack size or sorting error.",
    '403' = "Normalization pipeline failed: intermediate buffers invalid.",
    '404' = "Group averaging failed: mismatch between group_s and group_c.",
    '405' = "Fold change computation failed: unequal control and condition pairs.",
    '406' = "Log2 transformation failed: negative or zero values encountered.",
