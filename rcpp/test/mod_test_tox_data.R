...
validate_string_array_uniqueness(gene_family_ids)
...
validate_expression_data(kallisto_expr)
...
validate_shift_vectors(shift_vectors, kallisto_expr, family_centroids, gene_to_fam)
...
save_tox_data(zip_filename="test_archive_3_R.zip", gene_ids=gene_ids, gene_ids_name="gene_ids_v3_R.bin",
                      expression_vectors=kallisto_expr, expression_vectors_name="expr_vecs_v3_R.bin", gene_to_fam=gene_to_fam, gene_to_fam_name="gene_to_fam_v3_R.bin")
