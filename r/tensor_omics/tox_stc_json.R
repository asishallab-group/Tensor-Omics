...
#' @param filter_dim_min a integer scalar. This run's minimum tolerated final intrinsic dimension for reconciliation
...
#' @param filter_dim_max a integer scalar. This run's maximum tolerated final intrinsic dimension for reconciliation
#'   eligibility, inclusive -- see `tox_shape_truthful_clustering_filter_impl`'s own
