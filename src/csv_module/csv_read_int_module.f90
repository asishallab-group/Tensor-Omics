...
CONTAINS
    ...
    SUBROUTINE read_integer_columns(data_in, cols_to_read, int_data_out, status)
        ...
        ALLOCATE(int_data_out(num_rows, num_cols_out))
    ...
    END SUBROUTINE read_integer_columns

END MODULE csv_read_int_module
...
END SUBROUTINE read_integer_columns_r
