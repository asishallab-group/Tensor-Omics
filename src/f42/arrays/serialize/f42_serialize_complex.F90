...
module f42_arrays_serialize_complex
    use safeguard
    use, intrinsic :: iso_fortran_env, only: int32, real64
    use f42_arrays_utils, only: write_file_header, COMPLEX_TYPE_CODE
...
end module f42_arrays_serialize_complex
...
subroutine serialize_complex_nd_c(arr, orig_shape, n_dims, &
    ...
    use f42_arrays_serialize_complex, only: serialize_complex_helper
