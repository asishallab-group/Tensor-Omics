...
module f42_arrays_serialize_logical
    use safeguard
    use, intrinsic :: iso_fortran_env, only: int32, real64
    use f42_arrays_utils, only: write_file_header, LOGICAL_TYPE_CODE
...
end module f42_arrays_serialize_logical
...
subroutine serialize_logical_nd_c(arr, orig_shape, n_dims, &
    ...
    use f42_arrays_serialize_logical, only: serialize_logical_helper
