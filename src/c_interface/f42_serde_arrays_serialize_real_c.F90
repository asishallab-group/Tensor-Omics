...
!> summary: C-wrappers for [[f42_serde_arrays_serialize_real(module)]]
!| Module for serializing real arrays into files
module f42_serde_arrays_serialize_real_c
    use safeguard
    ...
    public :: serialize_real_helper_c

contains

    !> summary: C-wrapper for [[f42_serde_arrays_serialize_real(module):serialize_real_helper(subroutine)]]
    subroutine serialize_real_helper_c(&
            arr,&
            n_elements,&
            orig_shape,&
            ...
            filename_strlen,&
            ierr&
        ) bind(C, name="serialize_real_helper_c")
        use f42_serde_arrays_serialize_real, only: serialize_real_helper
        ...
        real(c_double), dimension(n_elements), intent(in), target :: arr
    ...
    end subroutine serialize_real_helper_c

end module f42_serde_arrays_serialize_real_c
#endif
