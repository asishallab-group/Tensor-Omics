...
!> summary: C-wrappers for [[f42_serde_arrays_deserialize_real(module)]]
...
module f42_serde_arrays_deserialize_real_c
    ...
    public :: deserialize_real_helper_c

contains

    !> summary: C-wrapper for [[f42_serde_arrays_deserialize_real(module):deserialize_real_helper(subroutine)]]
    subroutine deserialize_real_helper_c(&
            arr,&
            n_elements,&
            orig_shape,&
            ...
            filename_strlen,&
            ierr&
        ) bind(C, name="deserialize_real_helper_c")
        use f42_serde_arrays_deserialize_real, only: deserialize_real_helper
        ...
        real(c_double), dimension(n_elements), intent(out), target :: arr
    ...
    end subroutine deserialize_real_helper_c

end module f42_serde_arrays_deserialize_real_c
#endif
