...
contains
    ...
    subroutine serialize_int_3d_c(arr, n_arr_elements_dim_1, n_arr_elements_dim_2, n_arr_elements_dim_3, filename, filename_strlen, ierr) bind(C, name="serialize_int_3d_c")
        ...
        call serialize_int_3d(arr, filename_f, ierr)
