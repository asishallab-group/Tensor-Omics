...
void serialize_logical_helper_c(const unsigned char*, const int*, const int*, const int*, const char*, const int*, int*);

SEXP serialize_logical_helper_call(SEXP arr, SEXP filename) {
    int nprot = 0;
    ...
    unsigned char* arr_c = tox_bool_in(arr);
