...
void group_centroid_orthologs_expert_c(const double*, const int*, const int*, const int*, const int*, double*, int*, const unsigned char*, int*);
void group_centroid_orthologs_c(const double*, const int*, const int*, const int*, const int*, double*, const unsigned char*, int*);
void group_centroid_all_expert_c(const double*, const int*, const int*, const int*, const int*, double*, int*, int*);
...
SEXP group_centroid_orthologs_expert_call(SEXP expression_vectors, SEXP gene_to_family, SEXP n_families, SEXP ortholog_set) {
    int nprot = 0;
    // derived from the inputs, not asked of the caller
    int n_axes = INTEGER(Rf_getAttrib(expression_vectors, R_DimSymbol))[0];
    int n_genes = INTEGER(Rf_getAttrib(expression_vectors, R_DimSymbol))[1];
    ...
    group_centroid_orthologs_expert_c(
        REAL(expression_vectors),
        &n_axes,
        &n_genes,
...
SEXP group_centroid_orthologs_call(SEXP expression_vectors, SEXP gene_to_family, SEXP n_families, SEXP ortholog_set) {
    int nprot = 0;
    // derived from the inputs, not asked of the caller
    int n_axes = INTEGER(Rf_getAttrib(expression_vectors, R_DimSymbol))[0];
    int n_genes = INTEGER(Rf_getAttrib(expression_vectors, R_DimSymbol))[1];
...
SEXP group_centroid_all_expert_call(SEXP expression_vectors, SEXP gene_to_family, SEXP n_families) {
    int nprot = 0;
    // derived from the inputs, not asked of the caller
    int n_axes = INTEGER(Rf_getAttrib(expression_vectors, R_DimSymbol))[0];
    int n_genes = INTEGER(Rf_getAttrib(expression_vectors, R_DimSymbol))[1];
...
SEXP group_centroid_all_call(SEXP expression_vectors, SEXP gene_to_family, SEXP n_families) {
    int nprot = 0;
    // derived from the inputs, not asked of the caller
    int n_axes = INTEGER(Rf_getAttrib(expression_vectors, R_DimSymbol))[0];
    int n_genes = INTEGER(Rf_getAttrib(expression_vectors, R_DimSymbol))[1];
