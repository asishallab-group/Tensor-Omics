...
void serialize_stc_results_as_json_c(const char*, const int*, const int*, const int*, const int*, const int*, const int*, const int*, const double*, const char*, const int*, const unsigned char*, const unsigned char*, const int*, const double*, const double*, const double*, const int*, const double*, const double*, const int*, const unsigned char*, const int*, const int*, const int*, const double*, const int*, const double*, const double*, const double*, const int*, const double*, const double*, const char*, const double*, const int*, const int*, const double*, const double*, const double*, const int*, int*);
void write_stc_interactive_html_report_c(const char*, const int*, const int*, const int*, const int*, const int*, const int*, const int*, const double*, const char*, const int*, const unsigned char*, const unsigned char*, const int*, const double*, const double*, const double*, const int*, const double*, const double*, const int*, const unsigned char*, const int*, const int*, const int*, const double*, const int*, const double*, const double*, const double*, const int*, const double*, const double*, const char*, const double*, const int*, const int*, const double*, const double*, const double*, const int*, int*);

SEXP serialize_stc_results_as_json_call(SEXP filename, SEXP n_super_ensembles, SEXP vectors, SEXP dim_names, SEXP seed_selection_mask, SEXP ensemble_masks, SEXP ensemble_stop_reason, SEXP ensemble_growth_radii, SEXP ensemble_U_history, SEXP ensemble_S_history, SEXP ensemble_d_history, SEXP ensemble_G_history, SEXP ensemble_mu_history, SEXP ensemble_k_history, SEXP ensemble_low_confidence_masks, SEXP super_ensembles, SEXP k_min, SEXP k_density, SEXP chordal_dist_max_as_prcnt_of_range, SEXP d_max, SEXP G_max, SEXP RMSE_change_max, SEXP f_max, SEXP a, SEXP exclusion_radius_percentile, SEXP bandwidth_percentile, SEXP reconciliation_mode, SEXP min_overlap_coefficient, SEXP estimated_k_min, SEXP estimated_k_density, SEXP estimated_density_quantile, SEXP estimated_chordal_dist_max_as_prcnt_of_range, SEXP estimated_G_max, SEXP estimated_d_max) {
    int nprot = 0;
