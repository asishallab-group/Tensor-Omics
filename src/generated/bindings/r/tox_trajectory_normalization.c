...
void normalize_all_trajectories_expert_c(const double*, double*, const int*, const int*, const int*, double*, double*, int*, int*);
...
SEXP normalize_all_trajectories_expert_call(SEXP trajectories) {
    int nprot = 0;
    // derived from the inputs, not asked of the caller
    ...
    double* tmp_series = (double*) R_alloc(n_timepoints, sizeof(double));
    double* tmp_series_norm = (double*) R_alloc(n_timepoints, sizeof(double));
    ...
    normalize_all_trajectories_expert_c(
        REAL(trajectories),
