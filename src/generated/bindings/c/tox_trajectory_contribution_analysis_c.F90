...
contains
    ...
    !> summary: C-wrapper for [[tox_trajectory_contribution_analysis(module):perform_permutation_test_expert(subroutine)]]
    subroutine perform_permutation_test_expert_c(&
            trajectories,&
            n_factors,&
            n_samples,&
            n_timepoints,&
        ...
        call perform_permutation_test_expert(&
            trajectories = trajectories,&
            n_factors = n_factors,&
            n_samples = n_samples,&
            n_timepoints = n_timepoints,&
    ...
    end subroutine perform_permutation_test_expert_c
    ...
    !> summary: C-wrapper for [[tox_trajectory_contribution_analysis(module):compute_all_contributions_expert(subroutine)]]
    subroutine compute_all_contributions_expert_c(&
            trajectories,&
            n_factors,&
            n_samples,&
            n_timepoints,&
        ...
        call compute_all_contributions_expert(&
            trajectories = trajectories,&
            n_factors = n_factors,&
            n_samples = n_samples,&
            n_timepoints = n_timepoints,&
    ...
    end subroutine compute_all_contributions_expert_c
    ...
    !> summary: C-wrapper for [[tox_trajectory_contribution_analysis(module):compute_velocity_acceleration_contributions_expert(subroutine)]]
    !| @note
    !| Performance layout:
    !|
    !| `trajectories` uses `(n_factors, n_samples, n_timepoints)`.
    ...
    subroutine compute_velocity_acceleration_contributions_expert_c(&
        ...
        call compute_velocity_acceleration_contributions_expert(&
            trajectories = trajectories,&
            n_factors = n_factors,&
            n_samples = n_samples,&
            n_timepoints = n_timepoints,&
