...
!> summary: C-wrappers for [[tox_paralog_analysis_impl(module)]]
...
contains
    ...
    subroutine calc_work_arr_paralog_subsets_size_c(&
        ...
        use tox_paralog_analysis_impl, only: calc_work_arr_paralog_subsets_size
...
end module tox_paralog_analysis_impl_c
#endif
