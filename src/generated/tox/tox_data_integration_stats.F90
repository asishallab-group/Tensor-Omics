...
!> summary: Wrappers for [[tox_data_integration_stats_kernel(module)]]
!| Generated from the kernel; do not edit -- regenerate instead.
module tox_data_integration_stats
    use tox_data_integration_stats_kernel, only: gjct_permutation_test_kernel
    ...
    public :: gjct_permutation_test_alloc

contains

    !> summary: Validates its inputs, then calls [[tox_data_integration_stats_kernel(module):gjct_permutation_test_kernel]].
    ...
    !> summary: Allocates its work arrays, then calls [[tox_data_integration_stats_kernel(module):gjct_permutation_test_kernel]].
    !| Tests the null hypothesis that both studies are exchangeable. The residuals are shuffled in
    !| the work copies, so the caller's own arrays are left untouched.
    subroutine gjct_permutation_test_alloc(&
            neighborhood_residuals_S1,&
            neighborhood_residuals_S2,&
            n_reps_S1,&
            n_reps_S2,&
