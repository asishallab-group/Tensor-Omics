...
contains
    ...
    !> summary: C-wrapper for [[tox_trajectory_contribution_analysis(module):perform_permutation_test_alloc(subroutine)]]
    subroutine perform_permutation_test_c(&
        ...
        use tox_trajectory_contribution_analysis, only: perform_permutation_test_alloc
        use tox_trajectory_contribution_analysis_kernel, only: MODE_MEAN, MODE_MIN, MODE_RAW
        ...
        call perform_permutation_test_alloc(&
            trajectories = trajectories,&
            n_factors = n_factors,&
            n_samples = n_samples,&
            n_timepoints = n_timepoints,&
    ...
    !> summary: C-wrapper for [[tox_trajectory_contribution_analysis(module):compute_all_contributions_alloc(subroutine)]]
    subroutine compute_all_contributions_c(&
        ...
        use tox_trajectory_contribution_analysis, only: compute_all_contributions_alloc
        use tox_trajectory_contribution_analysis_kernel, only: MODE_MEAN, MODE_MIN, MODE_RAW
        ...
        call compute_all_contributions_alloc(&
            trajectories = trajectories,&
            n_factors = n_factors,&
            n_samples = n_samples,&
            n_timepoints = n_timepoints,&
