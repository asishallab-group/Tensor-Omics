...
module tox_data_read_write
    ...
    use f42_arrays_serialize, only: serialize_int_1d, serialize_real_2D, serialize_char_1D
    use f42_arrays_deserialize, only: deserialize_int_1D, deserialize_real_2D, deserialize_char_1D
    implicit none
