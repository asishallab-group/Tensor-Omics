...
module tox_trajectory_contribution_analysis
    ...
    public :: compute_velocity_acceleration_contributions_alloc

contains

    !> summary: Validates its inputs, then calls [[tox_trajectory_contribution_analysis_kernel(module):perform_permutation_test_kernel]].
    ...
    subroutine perform_permutation_test_alloc(&
            trajectories,&
            n_factors,&
            n_samples,&
            n_timepoints,&
    ...
    !> summary: Validates its inputs, then calls [[tox_trajectory_contribution_analysis_kernel(module):compute_contributions_kernel]].
    ...
    subroutine compute_all_contributions_alloc(&
            trajectories,&
            n_factors,&
            n_samples,&
            n_timepoints,&
    ...
    !> summary: Validates its inputs, then calls [[tox_trajectory_contribution_analysis_kernel(module):compute_acceleration_from_velocity_trajectory_kernel]].
    ...
    !> summary: Validates its inputs, then calls [[tox_trajectory_contribution_analysis_kernel(module):compute_velocity_trajectories_kernel]].
    ...
    !> summary: Validates its inputs, then calls [[tox_trajectory_contribution_analysis_kernel(module):compute_acceleration_from_velocity_kernel]].
    ...
    !> summary: Validates its inputs, then calls [[tox_trajectory_contribution_analysis_kernel(module):compute_velocity_acceleration_contributions_kernel]].
    !| @note
    !| Performance layout:
    !|
    ...
    !| avoids expensive tmporaries, and improves cache efficiency.
    !| @endnote
    subroutine compute_velocity_acceleration_contributions_alloc(&
            trajectories,&
            n_factors,&
            n_samples,&
            n_timepoints,&
