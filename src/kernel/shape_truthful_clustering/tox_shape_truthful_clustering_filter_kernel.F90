...
!| `merge_to_super_ensembles` (see the sibling `tox_shape_truthful_clustering_reconciliation_kernel`,
...
!| family already uses.
module tox_shape_truthful_clustering_filter_kernel
    use, intrinsic :: iso_fortran_env, only: int32, real64
    use tox_shape_truthful_clustering_observable_kernel, only: ensemble_final_observable_kernel, normal_error_kernel
    M_IMPLICIT_NONE

    private
    public :: filter_ensembles_by_stop_condition_kernel
    public :: filter_ensembles_by_dimension_kernel
    public :: filter_ensembles_by_var_explained_kernel
    public :: filter_ensembles_kernel
...
contains
    ...
    pure subroutine filter_ensembles_by_stop_condition_kernel(n_ensembles, ensemble_stop_reason, &
    ...
    end subroutine filter_ensembles_by_stop_condition_kernel
    ...
    pure subroutine filter_ensembles_by_dimension_kernel(n_dimensions, n_ensembles, ensemble_d_final, &
        ...
        integer(int32), intent(in) :: ensemble_d_final(n_ensembles)
            ...
            !! DM_MIN(0_int32)
            !! DM_MAX(n_dimensions)
        logical, intent(in) :: ensemble_has_final(n_ensembles)
    ...
    end subroutine filter_ensembles_by_dimension_kernel
    ...
    pure subroutine filter_ensembles_by_var_explained_kernel(n_dimensions, n_ensembles, ensemble_S_final, &
        ...
        do e = 1, n_ensembles
            ...
            call normal_error_kernel(d_e, eigenvalues, n_dimensions, normal_error_value)
    ...
    end subroutine filter_ensembles_by_var_explained_kernel
    ...
    pure subroutine filter_ensembles_kernel(n_dimensions, o, n_ensembles, &
        ...
        logical        :: ensemble_has_final(n_ensembles)
        integer(int32) :: ensemble_final_index(n_ensembles)

        call ensemble_final_observable_kernel(n_dimensions, o, n_ensembles, &
            ensemble_U_history, ensemble_d_history, ensemble_S_history, &
        ...
        call filter_ensembles_by_stop_condition_kernel(n_ensembles, ensemble_stop_reason, allowed_stop_reasons, &
            eligible_by_stop_condition)

        call filter_ensembles_by_dimension_kernel(n_dimensions, n_ensembles, ensemble_d_final, ensemble_has_final, &
            d_min, d_max, eligible_by_dimension)

        call filter_ensembles_by_var_explained_kernel(n_dimensions, n_ensembles, ensemble_S_final, ensemble_d_final, &
    ...
    end subroutine filter_ensembles_kernel

end module tox_shape_truthful_clustering_filter_kernel
