...
!| `compute_tissue_versatility_kernel` into the validating wrapper `compute_tissue_versatility` in
...
contains
    ...
    end subroutine compute_tissue_versatility_kernel

end module tox_tissue_versatility_kernel
