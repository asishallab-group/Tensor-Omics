...
module tox_data_integration_preprocessing_kernel
...
contains
    ...
    pure subroutine pool_study_means_kernel(n_genes_S1, mean_S1, n_genes_S2, mean_S2, n_points, &
        ...
        call pool_means_kernel(tmp_pooled_means, tmp_pooled_means_perm, pool_size, n_points, n_pool, x_star)

    end subroutine pool_study_means_kernel
    ...
    end subroutine construct_neighborhoods_kernel
end module tox_data_integration_preprocessing_kernel
