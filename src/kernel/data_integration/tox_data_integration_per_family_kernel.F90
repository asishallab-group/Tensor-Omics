...
!| turns the `*_kernel` procedures into the validating and allocating wrappers in module
!| tox_data_integration_per_family.
module tox_data_integration_per_family_kernel
...
contains
    ...
    pure subroutine fjct_compute_jsd_kernel(family_idx, gene_to_family_S1, gene_to_family_S2, n_genes_S1, n_genes_S2, neighborhood_residuals_S1, neighborhood_residuals_S2, &
        ...
        call fjct_compute_masked_jsd_kernel(neighborhood_residuals_S1, neighborhood_residuals_S2, n_reps_S1, n_reps_S2, n_neighbors, n_points, tmp_neighbor_mask_S1, tmp_neighbor_mask_S2, n_bins, shared_residual_range, js_divergences, included_n_reps_S1, included_n_reps_S2, total_included_n_reps, global_js_divergence, weights, tmp_pmf_S1, tmp_pmf_S2, tmp_counts)
    ...
    pure subroutine fjct_compute_masked_jsd_kernel(neighborhood_residuals_S1, neighborhood_residuals_S2, n_reps_S1, n_reps_S2, n_neighbors, n_points, neighbor_mask_S1, neighbor_mask_S2, n_bins, shared_residual_range, js_divergences, included_n_reps_S1, included_n_reps_S2, total_included_n_reps, global_js_divergence, weights, pmf_S1, pmf_S2, tmp_counts)
        integer(int32), intent(in) :: n_reps_S1
            !! Number of replicates in study 1
        integer(int32), intent(in) :: n_reps_S2
            !! Number of replicates in study 2
    ...
    pure subroutine fjct_compute_contribution_scores_kernel(global_js_divergences, total_included_n_reps_per_f, k_families, support_weights, contribution_scores)
    ...
    end subroutine fjct_compute_contribution_scores_kernel

end module tox_data_integration_per_family_kernel
