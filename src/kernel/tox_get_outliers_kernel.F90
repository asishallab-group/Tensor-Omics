...
module tox_get_outliers_kernel
    ...
    use tox_loess_kernel, only: tox_loess_required_workspace, EPS_LOESS, loess_evaluation, loess_fit_plain_kernel, loess_fit_robust_kernel
    M_IMPLICIT_NONE
...
#define CM_OUTLIER_PERCENTILE_DEFAULT 95.0_real64
...
contains
    ...
    subroutine detect_outliers_kernel(n_genes, n_families, distances, gene_to_fam, &
        ...
        call compute_rdi_kernel(n_genes, distances, gene_to_fam, tmp_dscale, tmp_rdi, tmp_sorted_rdi, tmp_perm, tmp_stack_left, tmp_stack_right)

        call identify_outliers_kernel(n_genes, tmp_rdi, tmp_sorted_rdi, tmp_perm, is_outlier, tmp_threshold, quantile, percentile)
    end subroutine detect_outliers_kernel
end module tox_get_outliers_kernel
