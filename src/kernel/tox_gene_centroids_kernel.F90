...
!| `group_centroid_kernel`, the per-mode wrappers `group_centroid_orthologs` and
!| `group_centroid_all` in module `tox_gene_centroids`.
module tox_gene_centroids_kernel
...
#define CM_MODE_GROUP_ALL 1_int32
    ...
    private
    public :: mean_vector_kernel, group_centroid_kernel
...
contains
    ...
    !| AUTHOR_LUKA_FAENSEN
    pure subroutine mean_vector_kernel(expression_vectors, n_axes, n_genes, gene_indices, n_selected_genes, centroid)
    ...
    end subroutine mean_vector_kernel

    !> summary: Iterates over families, filters gene indices, and computes centroids.
    !| AUTHOR_LUKA_FAENSEN
    pure subroutine group_centroid_kernel(expression_vectors, n_axes, n_genes, gene_to_family, n_families, &
        ...
        integer(int32), intent(in) :: mode
            ...
            !! |------|-------|-----------|
            !! | Group orthologs | [[tox_gene_centroids_kernel(module):MODE_GROUP_ORTHOLOGS(variable)]] | group_centroid_orthologs |
            !! | Group all | [[tox_gene_centroids_kernel(module):MODE_GROUP_ALL(variable)]] | group_centroid_all |
        ...
        logical, dimension(n_genes), intent(in), optional :: ortholog_set
            ...
            !! DM_REQUIRED_IF_MODE(mode, tox_gene_centroids_kernel, MODE_GROUP_ORTHOLOGS)
        ...
        do i_family = 1, n_families
            ...
            call mean_vector_kernel(expression_vectors, n_axes, n_genes, tmp_group_indices, n_selected, centroid_matrix(:, i_family))
        end do
    end subroutine group_centroid_kernel

end module tox_gene_centroids_kernel
