...
sprot_df <- process_uniprot_fasta("./Protein_Function_Prediction/material/uniprot_sprot.fasta", "sp")
trembl_df <- process_uniprot_fasta("./Protein_Function_Prediction/material/uniprot_trembl.fasta", "tr")
...
cat(nrow(combined_dt))
print(head(combined_dt))
...
saveRDS(combined_dt, "./Protein_Function_Prediction/material/protein2hrd.rds")
write.csv(combined_dt, "./Protein_Function_Prediction/material/protein2hrd.csv", row.names = TRUE)
