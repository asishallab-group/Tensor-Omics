...
extract_annotations <- function(annotation_data, result_list, annotation_col) {
  # keep original order based on K-D tree results
  ...
  annotation_data %>%
    ...
    # Add similarity to results as a form of "confidence score" -> evaluation purposes only
