...
| `generate_code.py` | entry point for the generator (`python helper/generate_code.py --help`) |
| `generate_snippets.py` | generates VS Code snippets from the sources (unrelated to the interface generator) |
