...
The snippets are generated by the code generator (`python helper/generate_code.py --target
snippets`); see the [code generator README](helper/codegen/README.md) for details.
