!> @brief Unit test suite for csv_parser_module.
...
CONTAINS
    ...
    !> @brief Get array of all available tests for the csv_parser suite.
    ...
    !> @brief Test parsing a simple line.
    SUBROUTINE test_simple_line()
        ...
        CALL assert_equal_size(SIZE(fields), 3, "test_simple_line: incorrect number of fields")
    ...
    !> @brief Test parsing a line with an empty field.
    SUBROUTINE test_empty_field()
        ...
        CALL assert_equal_size(SIZE(fields), 3, "test_empty_field: incorrect number of fields")
        CALL assert_string_equal(fields(2), "", "test_empty_field: empty field was not empty")
    END SUBROUTINE test_empty_field

    !> @brief Test parsing a complex number correctly.
    SUBROUTINE test_complex_field()
        ...
        CALL assert_equal_size(SIZE(fields), 3, "test_complex_field: incorrect number of fields")
