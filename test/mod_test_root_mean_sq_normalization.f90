! filepath: test/mod_test_root_mean_sq_normalization.f90
...
contains
  ...
  !> Run all root_mean_sq_normalization tests.
  subroutine run_all_tests_root_mean_sq_normalization()
    type(test_case) :: all_tests(13)
    integer(int32) :: i
    ...
    print *, "All root_mean_sq_normalization tests passed successfully."
  end subroutine run_all_tests_root_mean_sq_normalization

  !> Run specific root_mean_sq_normalization tests by name.
  subroutine run_named_tests_root_mean_sq_normalization(test_names)
  ...
  end subroutine run_named_tests_root_mean_sq_normalization
  ...
  subroutine test_root_mean_sq_normalization_large_numbers()
    ...
    call assert_true(all(isfinite_mat(result)), "root_mean_sq_normalization: Inf in result for large numbers")
  ...
  subroutine test_large_random_matrix()
    ...
    call root_mean_sq_normalization(nrow, ncol, mat, result, ierr)
    call assert_equal_int(ierr, 0, "root_mean_sq_normalization returned error")
    do i = 1, nrow
  ...
  subroutine test_nan_inf_input()
    ...
    call root_mean_sq_normalization(2, 2, mat, result, ierr)
    call assert_equal_int(ierr, 0, "root_mean_sq_normalization returned error")
    call assert_true(all(isfinite_mat(result)), "root_mean_sq_normalization: output contains NaN/Inf unexpectedly")
  ...
  subroutine test_empty_matrix()
    ...
    call assert_equal_int(ierr, 202, "root_mean_sq_normalization returned error")
