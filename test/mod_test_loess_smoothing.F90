...
contains
    ...
    subroutine test_loess_constant_input()
        ...
        call assert_equal_int(ierr, ERR_OK, 'Constant input error check')
    ...
    subroutine test_loess_linear_trend()
        ...
        call loess_smooth_2d(n, n/2, x_ref, y_ref, indices_used, n, x_query, 1.0_real64, 3.0_real64, y_out, ierr)
        call assert_equal_int(ierr, ERR_OK, 'Linear trend error check')
    ...
    subroutine test_loess_outlier_suppression()
        ...
        call assert_equal_int(ierr, ERR_OK, 'Outlier suppression error check')
    ...
    subroutine test_loess_sparse_fallback()
        ...
        indices_used = [(i, i=1, n)]
        call loess_smooth_2d(n, 50, x_ref, y_ref, indices_used, n, x_query, 1.0_real64, 3.0_real64, y_out, ierr)
        call assert_equal_int(ierr, ERR_OK, 'Sparse fallback error check')
    ...
    subroutine test_loess_single_point()
        ...
        call assert_equal_int(ierr, ERR_OK, 'Single point error check')
    ...
    subroutine test_loess_identical_points()
        ...
        call assert_equal_int(ierr, ERR_OK, 'Identical points error check')
    ...
    subroutine test_loess_linear_interp()
        ...
        call assert_equal_int(ierr, ERR_OK, 'Linear interpolation error check')
    ...
    subroutine test_loess_weight_decay()
        ...
        call assert_equal_int(ierr, ERR_OK, 'Weight decay error check')
    ...
    subroutine test_loess_mask_exclusion()
        ...
        call assert_equal_int(ierr, ERR_OK, 'Mask exclusion error check')
    ...
    subroutine test_loess_fallback()
        ...
        call loess_smooth_2d(1, 1, x1, y1, [1], 1, xq1, 0.1_real64, 1.0_real64, yout1, ierr)
        call assert_equal_int(ierr, ERR_OK, 'Fallback error check')
    ...
    subroutine test_loess_edge_query()
        ...
        call assert_equal_int(ierr, ERR_OK, 'Edge query error check')
    ...
    subroutine test_loess_invalid_dimensions()
        ...
        call assert_equal_int(ierr, create_err_code(ERR_EMPTY_INPUT, arg_pos=1_int32), 'Zero n_total error check')

        call loess_smooth_2d(5, 0, x, y, idx, 5, xq, 1.0_real64, 3.0_real64, yout, ierr)
        call assert_equal_int(ierr, create_err_code(ERR_EMPTY_INPUT, arg_pos=2_int32), 'Zero n_target error check')

        call loess_smooth_2d(5, 2, x, y, idx, 0, xq, 1.0_real64, 3.0_real64, yout, ierr)
        call assert_equal_int(ierr, create_err_code(ERR_EMPTY_INPUT, arg_pos=6_int32), 'Zero n_used error check')
    end subroutine
    ...
    subroutine test_loess_invalid_parameters()
        ...
        call loess_smooth_2d(5, 2, x, y, idx, 5, xq, -1.0_real64, 3.0_real64, yout, ierr)
        call assert_equal_int(ierr, create_err_code(ERR_INVALID_INPUT, arg_pos=8_int32), 'Negative sigma error check')

        ! Test with negative kernel_cutoff
        call loess_smooth_2d(5, 2, x, y, idx, 5, xq, 1.0_real64, -3.0_real64, yout, ierr)
        call assert_equal_int(ierr, create_err_code(ERR_INVALID_INPUT, arg_pos=9_int32), 'Negative cutoff error check')
    end subroutine
    ...
    subroutine test_loess_invalid_indices()
        ...
        call loess_smooth_2d(5, 2, x, y, idx, 5, xq, 1.0_real64, 3.0_real64, yout, ierr)
        call assert_equal_int(ierr, create_err_code(ERR_INVALID_INPUT, arg_pos=5_int32), 'Index too high error check')

        ! Test with index out of bounds (too low)
        idx = [0, 2, 3, 4, 5]  ! index 0 is out of bounds
        call loess_smooth_2d(5, 2, x, y, idx, 5, xq, 1.0_real64, 3.0_real64, yout, ierr)
        call assert_equal_int(ierr, create_err_code(ERR_INVALID_INPUT, arg_pos=5_int32), 'Index too low error check')
    end subroutine
