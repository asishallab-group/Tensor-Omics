...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    \item \textbf{R:} Functions in \texttt{tensoromics.rcpp} that call C wrappers via \texttt{Rcpp}
  \end{itemize}
\end{enumerate}
...
\subsection{R Interface via Rcpp}
...
\begin{itemize}
  ...
  \item All data validation is in R side, not Rcpp 
...
\begin{enumerate}
    ...
    \item \textbf{Python Wrapper:} Add the function to \texttt{tensoromics\_functions.py} using ctypes
    \item \textbf{R Wrapper:} Add the function to \texttt{tensoromics\_functions.cpp} using Rcpp and tensoromics\_functions.R
