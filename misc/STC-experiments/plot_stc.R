...
param_caption <- function(params) {
  ...
  keys <- c("k_min", "k_density", "bandwidth_percentile", "exclusion_radius_percentile", "alpha_max_deg",
            "d_max", "g_max", "f_max", "a", "o", "reconciliation_mode", "min_jsi", "n_vectors",
            "n_dimensions", "n_ensembles")
