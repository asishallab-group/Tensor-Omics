...
pure subroutine group_centroid_c(expression_vectors, n_axes, n_genes, gene_to_family, n_families, &
  ...
  integer(c_int), intent(in), target :: selected_indices_len
  ...
  character(c_char), intent(in), target :: mode(10)
