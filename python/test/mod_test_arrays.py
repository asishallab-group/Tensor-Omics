...
# from tensoromics_functions import (serialize_char_nd, serialize_int_nd, serialize_real_nd,
#                                    deserialize_char_nd, deserialize_int_nd, deserialize_real_nd,
#                                    serialize_logical_nd, serialize_complex_nd,
#                                    deserialize_logical_nd, deserialize_complex_nd)
from tox import *
...
def logical_test():
    ...
    serialize_logical_nd(array, filename)
    print(f"Serialized logical array to {filename}")
    res = deserialize_logical_nd(filename)
    ...
    serialize_logical_nd(array_2d, filename_2d)
    print(f"Serialized 2D logical array to {filename_2d}")
    res_2d = deserialize_logical_nd(filename_2d)
    print("Original 2D:")
    print(array_2d)
    ...
    serialize_logical_nd(array_3d, filename_3d)
    print(f"Serialized 3D logical array to {filename_3d}")
    res_3d = deserialize_logical_nd(filename_3d)
    ...
    serialize_logical_nd(all_true, "test_logical_all_true.bin")
    serialize_logical_nd(all_false, "test_logical_all_false.bin")
    
    res_all_true = deserialize_logical_nd("test_logical_all_true.bin")
    res_all_false = deserialize_logical_nd("test_logical_all_false.bin")
...
def complex_test():
    ...
    serialize_complex_nd(array, filename)
    print(f"Serialized complex array to {filename}")
    res = deserialize_complex_nd(filename)
    print("Original:", array)
    print("Deserialized:", res)
    ...
    serialize_complex_nd(array_2d, filename_2d)
    print(f"Serialized 2D complex array to {filename_2d}")
    res_2d = deserialize_complex_nd(filename_2d)
    print("Original 2D:")
    print(array_2d)
    print("Deserialized 2D:")
    print(res_2d)
    ...
    serialize_complex_nd(array_3d, filename_3d)
    print(f"Serialized 3D complex array to {filename_3d}")
    res_3d = deserialize_complex_nd(filename_3d)
    print("Original 3D shape:", array_3d.shape)
    print("Deserialized 3D shape:", res_3d.shape)
    ...
    serialize_complex_nd(pure_real, "test_complex_pure_real.bin")
    serialize_complex_nd(pure_imag, "test_complex_pure_imag.bin")
    serialize_complex_nd(mixed, "test_complex_mixed.bin")
    
    res_pure_real = deserialize_complex_nd("test_complex_pure_real.bin")
    res_pure_imag = deserialize_complex_nd("test_complex_pure_imag.bin")
    res_mixed = deserialize_complex_nd("test_complex_mixed.bin")
