...
def compute_all_contributions_kernel(
    ...
    Notes
    -----
    Generated from the Fortran procedure `tox_trajectory_contribution_analysis_kernel::compute_all_contributions_kernel`.
    """
...
def compute_baselines_factor_dependent_kernel(
    ...
    Notes
    -----
    Generated from the Fortran procedure `tox_trajectory_contribution_analysis_kernel::compute_baselines_factor_dependent_kernel`.
    """
    # accept anything array-like, converting only when C needs it
    try:
...
def compute_velocity_trajectory_kernel(
    ...
    Notes
    -----
    Generated from the Fortran procedure `tox_trajectory_contribution_analysis_kernel::compute_velocity_trajectory_kernel`.
    """
    # accept anything array-like, converting only when C needs it
    try:
...
def compute_acceleration_from_velocity_trajectory_kernel(
    ...
    Notes
    -----
    Generated from the Fortran procedure `tox_trajectory_contribution_analysis_kernel::compute_acceleration_from_velocity_trajectory_kernel`.
    """
    # accept anything array-like, converting only when C needs it
    try:
...
def compute_velocity_acceleration_contributions_kernel(
    ...
    Notes
    -----
    Generated from the Fortran procedure `tox_trajectory_contribution_analysis_kernel::compute_velocity_acceleration_contributions_kernel`.
    """
    # accept anything array-like, converting only when C needs it
    try:
        trajectories = np.asfortranarray(trajectories, dtype=np.float64)
