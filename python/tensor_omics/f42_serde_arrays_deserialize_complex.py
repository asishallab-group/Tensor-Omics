"""Python interface to Module for deserializing complex arrays from files

Generated from f42_serde_arrays_deserialize_complex. Do not edit.
"""
...
def deserialize_complex_helper(
    ...
    Notes
    -----
    Generated from the Fortran procedure `f42_serde_arrays_deserialize_complex::deserialize_complex_helper`.
    """
