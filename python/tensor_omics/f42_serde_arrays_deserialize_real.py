...
_lib.deserialize_real_helper_c.restype = None
_lib.deserialize_real_helper_c.argtypes = (
...
_DESERIALIZE_REAL_HELPER_ARGUMENTS = ("arr", "n_elements", "arr_shape", "filename", "ierr",)
#: For a derived argument, the one the caller passed it in
_DESERIALIZE_REAL_HELPER_ARGUMENT_SOURCES = (None, "arr", "arr", None, None,)

def deserialize_real_helper(
        filename,
):
    r"""Deserialize a flat real array from a file
    ...
    Notes
    -----
    Generated from the Fortran procedure `f42_serde_arrays_deserialize_real::deserialize_real_helper`, whose argument names are
    ...
    arr = np.empty((int(np.prod(arr_shape)),), dtype=np.float64, order='C')
    ierr = ctypes.c_int(0)

    _lib.deserialize_real_helper_c(
        arr.ravel(order='F'),
