"""Python interface to Module for serializing real arrays into files
...
def serialize_real_helper(
    ...
    Notes
    -----
    Generated from the Fortran procedure `f42_serde_arrays_serialize_real::serialize_real_helper`.
    """
