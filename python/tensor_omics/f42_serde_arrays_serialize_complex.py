...
_SERIALIZE_COMPLEX_HELPER_ARGUMENT_SOURCES = (None, "arr", "arr", None, None,)
...
def serialize_complex_helper(
    ...
    check_err_code(ierr.value, _SERIALIZE_COMPLEX_HELPER_ARGUMENTS, _SERIALIZE_COMPLEX_HELPER_ARGUMENT_SOURCES)
