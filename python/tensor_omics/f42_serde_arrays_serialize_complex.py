"""Python interface to Module for serializing complex arrays into files
...
def serialize_complex_helper(
    ...
    Notes
    -----
    Generated from the Fortran procedure `f42_serde_arrays_serialize_complex::serialize_complex_helper`.
    """
