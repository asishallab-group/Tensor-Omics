"""Python interface to Module for serializing character arrays into files

Generated from f42_serde_arrays_serialize_char. Do not edit.
"""
...
def serialize_char_helper(
    ...
    Notes
    -----
    Generated from the Fortran procedure `f42_serde_arrays_serialize_char::serialize_char_helper`.
    """
