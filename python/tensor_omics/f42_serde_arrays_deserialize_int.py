"""Python interface to Module for deserializing integer arrays from files

Generated from f42_serde_arrays_deserialize_int. Do not edit.
"""
...
_lib.deserialize_int_helper_c.restype = None
_lib.deserialize_int_helper_c.argtypes = (
...
_DESERIALIZE_INT_HELPER_ARGUMENTS = ("arr", "n_elements", "arr_shape", "filename", "ierr",)

def deserialize_int_helper(
        filename,
):
    r"""Deserialize a flat integer array from a file
    ...
    Notes
    -----
    Generated from the Fortran procedure `f42_serde_arrays_deserialize_int::deserialize_int_helper`.
    """
    ...
    arr = np.empty((int(np.prod(arr_shape)),), dtype=np.int32, order='C')
    ierr = ctypes.c_int(0)

    _lib.deserialize_int_helper_c(
        arr.ravel(order='F'),
    ...
    check_err_code(ierr.value, _DESERIALIZE_INT_HELPER_ARGUMENTS)
