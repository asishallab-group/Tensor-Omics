...
def create_zip_archive(
    ...
    Notes
    -----
    Generated from the Fortran procedure `tox_data_archive::create_zip_archive`.
    """
...
def save_tox_data(
    ...
    Notes
    -----
    Generated from the Fortran procedure `tox_data_archive::save_tox_data`.
    """
    # accept anything array-like, converting only when C needs it
    zip_filename = np.array([str(zip_filename).encode()], dtype="S")
...
def get_tox_data_dims(
    ...
    Notes
    -----
    Generated from the Fortran procedure `tox_data_archive::get_tox_data_dims`.
    """
    # accept anything array-like, converting only when C needs it
    zip_filename = np.array([str(zip_filename).encode()], dtype="S")
...
def read_tox_data_into(
    ...
    Notes
    -----
    Generated from the Fortran procedure `tox_data_archive::read_tox_data_into`.
    """
