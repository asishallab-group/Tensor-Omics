...
#: The wrapped procedure's arguments, so an error can name one
_COMPUTE_FAMILY_SCALING_ARGUMENTS = ("n_genes", "n_families", "distances", "gene_to_fam", "dscale", "loess_x", "loess_y", "indices_used", "ierr",)
...
#: The wrapped procedure's arguments, so an error can name one
_COMPUTE_RDI_ARGUMENTS = ("n_genes", "distances", "gene_to_fam", "dscale", "rdi", "sorted_rdi", "perm", "tmp_stack_left", "tmp_stack_right",)
...
def compute_family_scaling(
    ...
    r"""Allocates internal LOESS work arrays and computes per-family scaling factors
