...
_NORMALIZE_VARIABLE_TIMESERIES_ARGUMENTS = ("v", "v_norm", "n_points", "ierr", "status",)
...
#: The wrapped procedure's arguments, so an error can name one
_NORMALIZE_SINGLE_TRAJECTORY_ARGUMENTS = ("trajectory", "trajectory_norm", "n_factors", "n_timepoints", "ierr", "status",)
...
#: The wrapped procedure's arguments, so an error can name one
_NORMALIZE_ALL_TRAJECTORIES_ARGUMENTS = ("trajectories", "trajectories_norm", "n_factors", "n_samples", "n_timepoints", "ierr", "status",)
