...
def fjct_compute_jsd_expert(
    ...
    Notes
    -----
    Generated from the Fortran procedure `tox_data_integration_per_family::fjct_compute_jsd`.
    """
    ...
    tmp_neighbor_mask_S1 = np.empty((n_neighbors, n_points,), dtype=np.bool_, order='F')
    tmp_neighbor_mask_S2 = np.empty((n_neighbors, n_points,), dtype=np.bool_, order='F')
...
def fjct_compute_jsd(
    ...
    Notes
    -----
    Generated from the Fortran procedure `tox_data_integration_per_family::fjct_compute_jsd_alloc`.
    """
    # accept anything array-like, converting only when C needs it
    try:
        gene_to_family_S1 = np.ascontiguousarray(gene_to_family_S1, dtype=np.int32)
...
def fjct_compute_masked_jsd_expert(
        neighborhood_residuals_S1,
        neighborhood_residuals_S2,
        neighbor_mask_S1,
        neighbor_mask_S2,
    ...
    Notes
    -----
    Generated from the Fortran procedure `tox_data_integration_per_family::fjct_compute_masked_jsd`.
    """
    # accept anything array-like, converting only when C needs it
    try:
        neighborhood_residuals_S1 = np.asfortranarray(neighborhood_residuals_S1, dtype=np.float64)
    ...
    _lib.fjct_compute_masked_jsd_expert_c(
        neighborhood_residuals_S1,
        neighborhood_residuals_S2,
        ctypes.byref(ctypes.c_int(n_reps_S1)),
        ctypes.byref(ctypes.c_int(n_reps_S2)),
...
def fjct_compute_masked_jsd(
    ...
    Notes
    -----
    Generated from the Fortran procedure `tox_data_integration_per_family::fjct_compute_masked_jsd_alloc`.
    """
    # accept anything array-like, converting only when C needs it
    try:
        neighborhood_residuals_S1 = np.asfortranarray(neighborhood_residuals_S1, dtype=np.float64)
...
def fjct_compute_contribution_scores(
    ...
    Notes
    -----
    Generated from the Fortran procedure `tox_data_integration_per_family::fjct_compute_contribution_scores`.
    """
    # accept anything array-like, converting only when C needs it
    try:
